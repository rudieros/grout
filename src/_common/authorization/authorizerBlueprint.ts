...
export class AuthPolicy {
  ...
  private getStatementsForEffect(effect: any, methods: any[]) {
...
//   //     throw new OSError.ts(`Invalid HTTP verb ${verb}. Allowed verbs in AuthPolicy.HttpVerb`);
//   //   }
//   //
//   //   if (!this.pathRegex.test(resource)) {
//   //     throw new OSError.ts(`Invalid resource path: ${resource}. Path should match ${this.pathRegex}`);
//   //   }
//   //
//   //   let cleanedResource = resource;
//   //   if (resource.substring(0, 1) === '/') {
...
//     //     (!this.denyMethods || this.denyMethods.length === 0)) {
//     //     throw new OSError.ts('No statements defined for the policy');
//     //   }
//     //
//     //   const policy = {};
//     //   policy.principalId = this.principalId;
